...
var x2,y2:integer; 
begin
  Writeln ('Введите координаты для смещения:');
  Write ('X2 = '); Readln(X2);
  Write ('Y2 = '); Readln(Y2);
  x:=x2+x; y:=y2+y;
end;
...
procedure TRectangle.ChangeSize;
  ...
  begin
    Writeln ('Введите высоту и ширину, чтобы нрисовать прямоугольник');
    Write ('Сhangex = '); Readln(Changex);
    Write ('Changey = '); Readln(Changey);
  end;
...
{ TODO -oUser -cConsole Main : Insert code here }
  ...
  Writeln('Перемещёние прямоугольника!');
  Rectangle.Move;
  Rectangle.Show;
