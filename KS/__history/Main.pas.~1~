...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Vcl.Menus, About;
...
begin
  inc(k);
  Label1.Caption:='Кнопка "'+Button1.Caption+'"  нажата '+IntToStr(k)+' раз';
end;

procedure TForm1.Button2Click(Sender: TObject);
begin
  if RadioButton4.Checked=True then Form1.Color:=$FF33CC;
  if RadioButton1.Checked=True then Form1.Caption:='лабораторная работа №6,7,8';
